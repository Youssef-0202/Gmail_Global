...
@Component({
  selector: 'app-email-groupe-piece-joint-create-admin',
  templateUrl: './email-groupe-piece-joint-create-admin.component.html'
})
export class EmailGroupePieceJointCreateAdminComponent extends AbstractCreateController<EmailGroupePieceJointDto, EmailGroupePieceJointCriteria, EmailGroupePieceJointAdminService>  implements OnInit {
