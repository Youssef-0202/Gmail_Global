...
@Component({
  selector: 'app-type-contenu-create-admin',
  templateUrl: './type-contenu-create-admin.component.html'
})
export class TypeContenuCreateAdminComponent extends AbstractCreateController<TypeContenuDto, TypeContenuCriteria, TypeContenuAdminService>  implements OnInit {
