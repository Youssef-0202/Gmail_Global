...
@Component({
  selector: 'app-emailpiece-joint-edit-admin',
  templateUrl: './emailpiece-joint-edit-admin.component.html'
})
export class EmailpieceJointEditAdminComponent extends AbstractEditController<EmailpieceJointDto, EmailpieceJointCriteria, EmailpieceJointAdminService>   implements OnInit {
