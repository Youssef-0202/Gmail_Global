package ma.zs.emailling.zynerator.security.common;
...
import ma.zs.emailling.EmaillingApplication;
...
public class SecurityUtil {
    ...
    public static User getCurrentUser() {
        UserService userService= EmaillingApplication.getCtx().getBean(UserService.class);
