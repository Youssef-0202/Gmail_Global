...
import ma.zs.emailling.zynerator.exception.EntityNotFoundException;
import ma.zs.emailling.zynerator.history.HistBusinessObject;
import ma.zs.emailling.zynerator.history.HistCriteria;
import ma.zs.emailling.zynerator.repository.AbstractHistoryRepository;
import ma.zs.emailling.zynerator.security.bean.User;
import ma.zs.emailling.zynerator.security.service.facade.UserService;
import ma.zs.emailling.zynerator.specification.AbstractHistorySpecification;
import ma.zs.emailling.zynerator.util.RefelexivityUtil;
